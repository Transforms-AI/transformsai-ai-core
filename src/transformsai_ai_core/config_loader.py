...
def get_formatted_fields() -> dict[str, list[str]]:
    ...
    return {
        ...
        "cameras.capture": ["buffer_size", "opencv_backend", "max_frame_age_ms",
                            ...
                            "open_timeout", "rtsp_transport", "ffmpeg_options",
                            "health_log_interval", "restart", "timestamp"],
        "cameras.capture.restart": ["enabled", "delay", "backoff_start", "backoff_jitter",
                                    "reset_after", "max_attempts", "stall_timeout"],
        "cameras.capture.timestamp": ["enabled", "rect_ratios", "rect_coords", "hide_color",
                                      "font_color", "font_scale", "time_format"],
